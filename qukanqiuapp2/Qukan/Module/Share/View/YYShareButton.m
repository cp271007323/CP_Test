...
- (void)layoutSubviews
{
    ...
    if (self.titleLabel.text) {
        self.titleLabel.frame = CGRectMake(0, CGRectGetMaxY(self.imageView.frame) + 0.0, self.bounds.size.width, self.bounds.size.height - CGRectGetMaxY(self.imageView.frame) - 10.0);
    }
}
