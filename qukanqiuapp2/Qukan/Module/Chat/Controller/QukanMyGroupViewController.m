...
#import "QukanGroupSetterViewController.h"  //群组设置

#import "QukanChatMemberCell.h"

#import <SDAutoLayout/SDAutoLayout.h>

@interface QukanMyGroupViewController ()<
UITableViewDelegate,
...
@implementation QukanMyGroupViewController
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    QukanGroupSetterViewController *vc = [QukanGroupSetterViewController new];
