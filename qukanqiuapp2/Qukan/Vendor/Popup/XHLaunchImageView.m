...
-(UIImage *)imageFromLaunchImage{
    ...
    QukanPopupLog(@"获取LaunchImage失败!请检查是否添加启动图,或者规格是否有误.");
    return nil;
}
...
-(UIImage *)imageFromLaunchScreen{
    ...
    if(UILaunchStoryboardName == nil){
        QukanPopupLog(@"从 LaunchScreen 中获取启动图失败!");
        return nil;
    }
...
-(UIImage*)imageFromView:(UIView*)view{
    //fix bug:https://github.com/CoderZhuXH/QukanPopup/issues/203
...
-(UIImage *)launchImageWithType:(NSString *)type{
    //比对分辨率,获取启动图 fix #158:https://github.com/CoderZhuXH/QukanPopup/issues/158
