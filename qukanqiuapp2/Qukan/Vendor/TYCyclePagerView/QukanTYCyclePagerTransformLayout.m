...
@interface QukanTYCyclePagerTransformLayout () {
    struct {
...
@interface QukanTYCyclePagerViewLayout ()
...
@implementation QukanTYCyclePagerTransformLayout
...
- (void)setDelegate:(id<QukanTYCyclePagerTransformLayoutDelegate>)delegate {
    _delegate = delegate;
...
- (void)setLayout:(QukanTYCyclePagerViewLayout *)layout {
    _layout = layout;
...
{
    return _layout.layoutType == QukanTYCyclePagerTransformLayoutNormal ? [super shouldInvalidateLayoutForBoundsChange:newBounds] : YES;
}

- (NSArray<UICollectionViewLayoutAttributes *> *)layoutAttributesForElementsInRect:(CGRect)rect {
    if (_delegateFlags.applyTransformToAttributes || _layout.layoutType != QukanTYCyclePagerTransformLayoutNormal) {
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    }else if(_layout.layoutType != QukanTYCyclePagerTransformLayoutNormal){
...
- (void)initializeTransformAttributes:(UICollectionViewLayoutAttributes *)attributes layoutType:(QukanTYCyclePagerTransformLayoutType)layoutType {
    switch (layoutType) {
        case QukanTYCyclePagerTransformLayoutLinear:
            [self applyLinearTransformToAttributes:attributes scale:_layout.minimumScale alpha:_layout.minimumAlpha];
            break;
        case QukanTYCyclePagerTransformLayoutCoverflow:
        {
...
- (void)applyTransformToAttributes:(UICollectionViewLayoutAttributes *)attributes layoutType:(QukanTYCyclePagerTransformLayoutType)layoutType {
    switch (layoutType) {
        case QukanTYCyclePagerTransformLayoutLinear:
...
@implementation QukanTYCyclePagerViewLayout
