...
@interface QukanTYPageControl : UIControl

@property (nonatomic, assign) NSInteger QukanNumberOfPages;
...
//- (void)QukansetCurrentPage:(NSInteger)currentPage animate:(BOOL)animate;
