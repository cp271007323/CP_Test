...
@interface QukanTYCyclePagerView () <UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, QukanTYCyclePagerTransformLayoutDelegate> {
    struct {
...
@property(nonatomic, strong) NSTimer *QukanTimer;
...
@implementation QukanTYCyclePagerView
...
- (void)addCollectionView {
    QukanTYCyclePagerTransformLayout *layout = [[QukanTYCyclePagerTransformLayout alloc]init];
...
- (QukanTYCyclePagerViewLayout *)layout {
    if (!_layout) {
...
- (void)setDelegate:(id<QukanTYCyclePagerViewDelegate>)delegate {
    _delegate = delegate;
    ...
    if (self.collectionView && self.collectionView.collectionViewLayout) {
        ((QukanTYCyclePagerTransformLayout *)self.collectionView.collectionViewLayout).delegate = _delegateFlags.applyTransformToAttributes ? self : nil;
    }
}

- (void)setDataSource:(id<QukanTYCyclePagerViewDataSource>)dataSource {
...
- (void)updateLayout {
    ...
    ((QukanTYCyclePagerTransformLayout *)_collectionView.collectionViewLayout).layout = self.layout;
}
...
#pragma mark - QukanTYCyclePagerTransformLayoutDelegate
...
- (void)dealloc {
    ((QukanTYCyclePagerTransformLayout *)_collectionView.collectionViewLayout).delegate = nil;
