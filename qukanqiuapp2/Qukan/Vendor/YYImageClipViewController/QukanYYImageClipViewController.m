//
//  QukanYYImageClipViewController.m
...
@interface QukanYYImageClipViewController ()
...
@implementation QukanYYImageClipViewController
...
- (void)initView {
    self.view.backgroundColor = kCommonBlackColor;
    ...
    self.overlayView.backgroundColor = kCommonBlackColor;
