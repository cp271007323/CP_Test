...
@interface QukanSensitiveTextTool ()
...
@implementation QukanSensitiveTextTool

static QukanSensitiveTextTool *instance;
...
- (instancetype)init{
    ...
    if (self) {
        ...
        //加载本地文件
        NSString *filePath = @"你妈|妈|爸|你大爷|母亲|父亲|狗|儿子|爹|爷|鸡|车撞|日你|你家|全家|死全|全死|操|狗东西|屎";
...
//    NSString *fileString = [[NSString alloc]initWithContentsOfFile:filepath encoding:NSUTF8StringEncoding error:nil];
    ...
    [self.rootArray addObjectsFromArray:[filepath componentsSeparatedByString:@"|"]];
