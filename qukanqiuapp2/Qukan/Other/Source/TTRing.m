...
- (void)animateToRadius:(CGFloat)radius toColor:(UIColor *)toColor duration:(NSTimeInterval)duration delay:(NSTimeInterval)delay
{
    ...
    NSLayoutConstraint *heightConstraint = [self TTConstraintForAttribute:NSLayoutAttributeWidth theView:self];
    NSLayoutConstraint *widthConstraint = [self TTConstraintForAttribute:NSLayoutAttributeHeight theView:self];
