...
- (void)tapBack {
    [self dismissWithNothingHappend];
}
...
-(void)dismissWithNothingHappend{
...
-(void)initializePickerViewInView: (UIView *)view
  ...
  [_pickerViewContainerView setBackgroundColor: COLOR_HEX(0x000000, 0.4)];
  ...
  _pickerContainerView = [[UIView alloc] initWithFrame:CGRectMake(0.0, _pickerViewContainerView.bounds.size.height - 260.0, kScreenWidth, 260.0)];
  ...
  if (pickerViewTextColor==nil) {
    pickerViewTextColor = kCommonBlackColor;
  }
  ...
  _pickerViewBarButtonItem = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemDone target:self action:@selector(dismiss)];
    ...
    UIBarButtonItem* cancleBtn = [[UIBarButtonItem alloc] initWithBarButtonSystemItem:UIBarButtonSystemItemCancel target:self action:@selector(dismissWithNothingHappend)];
    
    
  _pickerViewToolBar.items = @[cancleBtn,flexibleSpace, _pickerViewBarButtonItem];
 [_pickerViewBarButtonItem setTitleTextAttributes:@{ NSFontAttributeName : kFont14 } forState:UIControlStateNormal];
     [cancleBtn setTitleTextAttributes:@{ NSFontAttributeName : kFont14 } forState:UIControlStateNormal];
  [_pickerViewBarButtonItem setTintColor:buttonTextColor];
    [cancleBtn setTintColor:HEXColor(0x666666)];
  ...
  */
  ...
  //Add pickerView
  _pickerView = [[UIPickerView alloc] initWithFrame:CGRectMake(0.0, 44.0, kScreenWidth, 216.0)];
